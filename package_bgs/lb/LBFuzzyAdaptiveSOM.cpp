...
{
  CvFileStorage* fs = cvOpenFileStorage("./LBFuzzyAdaptiveSOM.xml", 0, CV_STORAGE_WRITE);
...
{
  CvFileStorage* fs = cvOpenFileStorage("./LBFuzzyAdaptiveSOM.xml", 0, CV_STORAGE_READ);
